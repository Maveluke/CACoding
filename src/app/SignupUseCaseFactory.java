...
public class SignupUseCaseFactory {
    ...
    private static ClearController createClearController(ClearViewModel clearViewModel,
                                                         ClearUserDataAccessInterface userDataObject) throws IOException{
        ClearOutputBoundary clearOutputBoundary = new ClearPresenter(clearViewModel);
        ClearInputBoundary clearInteractor = new ClearInteractor(userDataObject, clearOutputBoundary);
